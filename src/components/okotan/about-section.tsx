...
export function AboutSection() {
  return (
    <section className="relative h-[1024px] w-full overflow-hidden lg:h-[900px]">
      <div
      ...
      <div className="relative flex h-full flex-col items-center px-6 pt-[212px] lg:px-10">
        <div className="flex flex-col items-center gap-[60px] lg:gap-20">
          <p className="max-w-[663px] whitespace-pre-line text-center font-[family-name:var(--font-body)] text-2xl leading-[1.2] text-[var(--ok-white)] lg:max-w-[785px]">
