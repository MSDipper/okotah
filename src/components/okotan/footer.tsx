  ...
  return (
    <footer ref={logoRef} className="relative w-full overflow-hidden bg-[var(--ok-dark)]">
      <div className="relative mx-auto h-[560px] w-full max-w-[1600px] md:h-[700px] lg:h-[560px] xl:h-[580px] 2xl:h-[610px]">
        <div className="absolute bottom-[-44px] left-1/2 hidden w-full -translate-x-1/2 text-center md:block ">
          <span
        ...
        <div className="absolute bottom-[140px] right-6 flex flex-col gap-[32px] md:bottom-auto md:right-[40px] md:top-[280px] md:text-right lg:left-[1080px] lg:right-auto lg:top-[48px] lg:text-left xl:left-[1180px] 2xl:left-[1315px]">
        ...
        <div className="absolute right-6 md:right-[40px] md:top-[460px] lg:left-[1080px] lg:right-auto lg:top-[300px] xl:left-[1180px] 2xl:left-[1315px]">
          <div className="flex flex-col gap-[10px]">
            ...
            <a href="https://jetstyle.ru/" className="font-[family-name:var(--font-body)] text-[12px] leading-[1.2] text-[var(--ok-white)] md:text-right lg:text-left">
