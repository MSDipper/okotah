...
export default function HomePage() {
  return (
    <div className="bg-[var(--ok-cream)]">
      ...
      <div id="rooms-content" className="relative bg-[var(--ok-cream)] px-6 py-[100px] lg:py-[150px]" style={{ zIndex: 4 }}>
        <RoomsSection />
      </div>
      ...
      <div id="offers-content" className="relative bg-[var(--ok-cream)] px-6 py-[100px] lg:py-[150px]" style={{ zIndex: 8 }}>
        <SpecialOffersSection />
      </div>
      ...
      <div id="services-content" className="relative bg-[var(--ok-cream)] px-6 py-[100px] lg:py-[150px]" style={{ zIndex: 10 }}>
